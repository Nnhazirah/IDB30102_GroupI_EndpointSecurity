...
class XGBoostDetector:
    """
    XGBoost Classifier for behavioural ransomware detection.
    Gradient boosted trees for high detection precision, low false-positive rate,
    and ranking feature importance.
    """
    ...
    def get_feature_importance(self, feature_names=None):
        """Returns mapping of feature names to XGBoost feature importance scores."""
        if not self.is_trained:
    ...
    def save_model(self, filepath):
        """Persists trained XGBoost model and scaler."""
    ...
    def load_model(self, filepath):
        """Loads saved XGBoost model and scaler."""
