...
class SVMDetector:
    """
    Support Vector Machine (SVM) Classifier for behavioural ransomware detection.
    Uses RBF kernel with feature standardization to classify high-dimensional endpoint metrics.
    """
    ...
    def train(self, X, y, feature_names=None):
        """Trains the SVM model on standardized features."""
    ...
    def save_model(self, filepath):
        """Persists trained SVM model and standard scaler."""
    ...
    def load_model(self, filepath):
        """Loads saved SVM model and scaler."""
